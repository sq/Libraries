...
void GLContext::drawImage(image::Image & image, float x, float y) {
  return drawImage(image, x, y, 1.0f);
}

void GLContext::drawImage(image::Image & image, float x, float y, float opacity) { 
