...
** OP_IsUnique opcode on this cursor. */
    ...
    */
    public class MemRef {
        ...
        public MemRef (Mem mem) {
            inner = mem;
        }

        public MemRef (ref Mem mem) {
            inner = mem;
        }
        ...
        public void CopyTo (MemRef ct) {
            inner.CopyTo(ref ct.inner);
        }
        ...
        public RowSet upRowSet {
            get {
                return inner.upRowSet;
            }
            set {
                inner.upRowSet = value;
            }
        }
        ...
        public StrAccum _StrAccum {
            get {
                return inner._StrAccum;
            }
            set {
                inner._StrAccum = value;
            }
        }

        public object _MD5Context {
            get {
                return inner._MD5Context;
            }
            set {
                inner._MD5Context = value;
            }
        }
    }
    ...
    public struct Mem
    {
      public i64 ui;               /* Integer value. */
      public int unZero;           /* Used when bit MEM_Zero is set in flags */
      public FuncDef upDef;        /* Used only when flags==MEM_Agg */
      public RowSet upRowSet;      /* Used only when flags==MEM_RowSet */
...
set { _flags = value; }
      ...
      public MemRef _Mem;           /* Used when C# overload Z as MEM space */
...
//#endif
    ...
    */
    ...
    static void MemSetTypeFlag( MemRef p, int f ) { p.flags = (u16)( p.flags & ~( MEM_TypeMask | MEM_Zero ) | f ); }// TODO -- Convert back to inline for speed
...
*/
    ...
    */
    public class sqlite3_context
    {
      ...
      public MemRef s = new MemRef();    /* The return value is stored here */
      public MemRef pMem;             /* Memory cell used to store aggregate context */
    ...
    */
    public class Vdbe
    {
      ...
      public MemRef[] apArg;            /* Arguments to currently executing user function */
      public MemRef[] aColName;         /* Column names to return */
      public MemRef[] pResultSet;       /* Pointer to an array of results */
      ...
      public MemRef[] aVar;             /* Values for the OP_Variable opcode. */
      ...
      public MemRef[] aMem;             /* The memory locations */
...
//  int sqlite3VdbeMemExpandBlob(Mem *);
    ...
    static int sqlite3VdbeMemExpandBlob( MemRef x ) { return SQLITE_OK; }
#endif
