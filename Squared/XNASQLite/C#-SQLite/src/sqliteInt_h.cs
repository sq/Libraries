...
*/
    ...
    */
    public struct UnpackedRecord
    {
      ...
      public MemRef[] aMem;         /* Values */

      public static UnpackedRecord Empty = new UnpackedRecord();

      public bool IsEmpty {
          get {
              return (pKeyInfo == null) && (nField == 0) && (flags == 0) && (rowid == 0) && (aMem == null);
          }
      }
    };
