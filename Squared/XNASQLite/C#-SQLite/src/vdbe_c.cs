...
*/
    ...
    static void updateMaxBlobsize( MemRef p )
    {
...
*/
    ...
    static void UPDATE_MAX_BLOBSIZE( MemRef P ) { updateMaxBlobsize( P ); }
#else
...
*/
    ...
    */
    ...
    static int ExpandBlob( MemRef P ) { return ( P.flags & MEM_Zero ) != 0 ? sqlite3VdbeMemExpandBlob( P ) : 0; }
    ...
    */
    static void storeTypeInfo( MemRef A, int B )
    {
      _storeTypeInfo( A );
    }
    static void _storeTypeInfo( MemRef pMem )
    {
    ...
    */
    ...
    )
    {
      ...
      */
      MemRef pMem = p.aMem[p.nMem - iCur];
    ...
    */
    static void applyNumericAffinity( MemRef pRec )
    {
    ...
    */
    ...
    MemRef pRec,          /* The value to apply affinity to */
    ...
    */
    ...
    {
      applyAffinity( (MemRef)pVal, affinity, enc );
    }
...
*/
    static void sqlite3VdbeMemPrettyPrint( MemRef pMem, StringBuilder zBuf )
    {
      zBuf.Length = 0;
      string zCsr = "";
      int f = pMem.flags;
      ...
      if ( ( f & MEM_Blob ) != 0 )
      {
        ...
        if ( ( f & MEM_Zero ) != 0 )
        {
          sqlite3_snprintf( 100, ref zCsr, "+%dz", pMem.unZero );
          zBuf.Append( zCsr );//zCsr += sqlite3Strlen30(zCsr);
        }
        //*zCsr = '\0';
      }
...
*/
    static void memTracePrint( FILE _out, MemRef p )
    {
      ...
      {
        fprintf( _out, " si:%lld", p.ui );
#if !SQLITE_OMIT_FLOATING_POINT
      }
      else if ( ( p.flags & MEM_Int ) != 0 )
      {
        fprintf( _out, " i:%lld", p.ui );
#endif
      }
    ...
    static void registerTrace( FILE _out, int iReg, MemRef p )
    {
    ...
    static void REGISTER_TRACE( Vdbe p, int R, MemRef M )
    {
...
*/
    ...
    )
    {
      ...
      MemRef pIn1 = null;             /* 1st input operand */
      MemRef pIn2 = null;             /* 2nd input operand */
      MemRef pIn3 = null;             /* 3rd input operand */
      MemRef pOut = null;             /* Output operand */
      int opProperty;
          ...
          case OP_Variable:
            {
              ...
              MemRef pVar;        /* Value being transferred */
          ...
          case OP_ResultRow:
            {
              ...
              */
              ...
              p.pResultSet = new MemRef[pOp.p2];
              for ( i = 0 ; i < pOp.p2 ; i++ )
              {
          ...
          case OP_Column:
            {
              ...
              MemRef pDest;         /* Where to write the extracted value */
...
rc = SQLITE_CORRUPT_BKPT;
                ...
                */
                if ( zRec == null && avail < len )
                {
                  sMem.db = null;
                  sMem.flags = 0;
                  rc = sqlite3VdbeMemFromBtree( pCrsr, 0, len, pC.isIndex, ref sMem );
                  if ( rc != SQLITE_OK )
                  {
                    goto op_column_out;
                  }
                ...
                */
                ...
                sqlite3VdbeMemRelease( ref sMem );
                sMem.flags = MEM_Null;
              ...
              */
              if ( aOffset[p2] != 0 )
              {
                ...
                else
                {
                  ...
                  sqlite3VdbeMemMove( ref sMem, pDest );
                  rc = sqlite3VdbeMemFromBtree( pCrsr, (int)aOffset[p2], len, pC.isIndex, ref sMem );
                  if ( rc != SQLITE_OK )
                  {
                    goto op_column_out;
                  }
          ...
          */
          case OP_SetCookie:
            {       /* in3 */
              ...
              rc = sqlite3BtreeUpdateMeta( pDb.pBt, pOp.p2, (u32)pIn3.ui );
              if ( pOp.p2 == BTREE_SCHEMA_VERSION )
              {
                /* When the schema cookie changes, record the new cookie internally */
                pDb.pSchema.schema_cookie = (int)pIn3.ui;
                db.flags |= SQLITE_InternChanges;
              }
              else if ( pOp.p2 == BTREE_FILE_FORMAT )
              {
                /* Record changes in the file format */
                pDb.pSchema.file_format = (u8)pIn3.ui;
              }
              if ( pOp.p1 == 1 )
              {
              ...
              if ( pC.pCursor != null )
              {
                ...
                if ( pC.isTable )
                {
                  ...
                  ** loss of information, then special processing is required... */
                  ...
                  rc = sqlite3BtreeMovetoUnpacked( pC.pCursor, ref UnpackedRecord.Empty, iKey, 0, ref res );
                  if ( rc != SQLITE_OK )
                  {
                    goto abort_due_to_error;
                  }
                ...
                else
                {
                  ...
                  r.aMem = new MemRef[r.nField];
                  for ( int rI = 0 ; rI < r.nField ; rI++ ) r.aMem[rI] = p.aMem[pOp.p3 + rI];// r.aMem = p.aMem[pOp.p3];
                  rc = sqlite3BtreeMovetoUnpacked( pC.pCursor, ref r, 0, 0, ref res );
                  if ( rc != SQLITE_OK )
                  {
                    goto abort_due_to_error;
                  }
          ...
          */
          ...
          case OP_Found:
            {        /* jump, in3 */
              ...
              VdbeCursor pC;
              int res;
              UnpackedRecord pIdxKey = new UnpackedRecord();
              ...
              if ( ALWAYS( pC.pCursor != null ) )
              {
                ...
                ExpandBlob( pIn3 );
                sqlite3VdbeRecordUnpack( pC.pKeyInfo, pIn3.n, pIn3.zBLOB, ref pIdxKey, 0 );//sizeof( aTempRec ) );
                if ( pOp.opcode == OP_Found )
                {
                  pIdxKey.flags |= UNPACKED_PREFIX_MATCH;
                }
                rc = sqlite3BtreeMovetoUnpacked( pC.pCursor, ref pIdxKey, 0, 0, ref res );
                sqlite3VdbeDeleteUnpackedRecord( ref pIdxKey );
                if ( rc != SQLITE_OK )
                {
                  break;
                }
            ...
            {        /* jump, in3 */
              ...
              if ( pCrsr != null )
              {
                ...
                ** register P3 and fall through to the next instruction.  */
                rc = sqlite3BtreeMovetoUnpacked( pCrsr, ref r, 0, 0, ref pCx.seekResult );
          ...
          case OP_NotExists:
            {        /* jump, in3 */
              ...
              if ( pCrsr != null )
              {
                res = 0;
                iKey = pIn3.ui;
                rc = sqlite3BtreeMovetoUnpacked( pCrsr, ref UnpackedRecord.Empty, (long)iKey, 0, ref res );
                pC.lastRowid = pIn3.ui;
          ...
          */
          case OP_Sequence:
            {           /* out2-prerelease */
              ...
              pOut.ui = (long)p.apCsr[pOp.p1].seqCount++;
              MemSetTypeFlag( pOut, MEM_Int );
              break;
            }
          ...
          */
          case OP_NewRowid:
            {           /* out2-prerelease */
              ...
              MemRef pMem;              /* Register holding largest rowid for AUTOINCREMENT */
...
*/
                ...
                if ( !pC.useRandomRowid )
                {
                  ...
                  if ( pOp.p3 != 0 )
                  {
                    ...
                    if ( pMem.ui == MAX_ROWID || pC.useRandomRowid )
                    {
                      rc = SQLITE_FULL;
                      goto abort_due_to_error;
                    }
...
** an AUTOINCREMENT table. */
                  ...
                  do
                  {
                    ...
                    rc = sqlite3BtreeMovetoUnpacked( pC.pCursor, ref UnpackedRecord.Empty, v, 0, ref res );
                    cnt++;
          ...
          case OP_Insert:
            {
              ...
              if ( ( pOp.p5 & OPFLAG_LASTROWID ) != 0 ) db.lastRowid = pKey.ui;
          ...
          case OP_IdxDelete:
            {
              ...
              if ( ALWAYS( pCrsr != null ) )
              {
                ...
                rc = sqlite3BtreeMovetoUnpacked( pCrsr, ref r, 0, 0, ref res );
                if ( rc == SQLITE_OK && res == 0 )
                {
          ...
          case OP_IdxGE:
            {        /* jump, in3 */
              ...
              if ( ALWAYS( pC.pCursor != null ) )
              {
                ...
                r.aMem = new MemRef[r.nField];
                for ( int rI = 0 ; rI < r.nField ; rI++ ) r.aMem[rI] = p.aMem[pOp.p3 + rI];// r.aMem = p.aMem[pOp.p3];
                rc = sqlite3VdbeIdxKeyCompare( pC, ref r, ref res );
          ...
          case OP_IntegrityCk:
            {
              ...
              MemRef pnErr;       /* Register keeping track of errors remaining */
...
*/
          case OP_RowSetAdd:
            {       /* in2 */
              ...
              sqlite3RowSetInsert( pIdx.upRowSet, pVal.ui );
              break;
            }
          ...
          */
          case OP_RowSetRead:
            {       /* jump, out3 */
              ...
              pOut = p.aMem[pOp.p3];
              if ( ( pIdx.flags & MEM_RowSet ) == 0
              || sqlite3RowSetNext( pIdx.upRowSet, ref val ) == 0
              )
              {
          ...
          case OP_RowSetTest:
            {                     /* jump, in1, in3 */
              ...
              */
              ...
              if ( iSet != 0 )
              {
                exists = sqlite3RowSetTest( pIn1.upRowSet,
              ...
              if ( iSet >= 0 )
              {
                sqlite3RowSetInsert( pIn1.upRowSet, pIn3.ui );
              }
              break;
            }
