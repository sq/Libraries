...
namespace CS_SQLite3
{
  ...
  public partial class csSQLite
  {
    ...
    */
    ...
    static readonly MemRef nullMemRef = new MemRef();
...
end_of_step:
    ...
    */
    static MemRef sqlite3_aggregate_context( sqlite3_context p, int nByte )
    {
      MemRef pMem;
...
*/
    ...
    ** of NULL.
    */
    static MemRef columnMem( sqlite3_stmt pStmt, int i )
    {
      Vdbe pVm;
      int vals;
      MemRef pOut;
...
return bindText(pStmt, i, zData, nData, xDel, SQLITE_UTF16NATIVE);
    ...
    static int sqlite3_bind_value( sqlite3_stmt pStmt, int i, sqlite3_value pValue )
    {
      ...
      switch ( pValue.type )
      {
        case SQLITE_INTEGER:
          {
            rc = sqlite3_bind_int64( pStmt, i, pValue.ui );
            break;
          }
        case SQLITE_FLOAT:
          {
        ...
        case SQLITE_BLOB:
          {
            ...
            {
              rc = sqlite3_bind_zeroblob( pStmt, i, pValue.unZero );
            }
            else
            {
