    ...
    static int sqlite3AtoF( string z, ref double pResult )
    {
      ...
      if ( z.Length > 1 )
      {
        ...
        if ( z[zDx] == '.' )
        {
          ...
          { if ( !XDouble.TryParse( z.Substring( 0, zDx ), out v1 ) ) v1 = 0; }
          else v1 /= divisor;
        }
        if ( z[zDx] == 'e' || z[zDx] == 'E' )
        {
...
return sqlite3Atoi64(z, pResult);
    ...
    */
    static bool sqlite3Atoi64( string zNum, ref i64 pNum )
    {
      ...
      return XInt64.TryParse( zNum.Substring( 0, i ), out pNum
      );
      //i64 v = 0;
      //int neg;
      //int i, c;
    ...
    */
    static bool sqlite3FitsIn64Bits( string zNum, bool negFlag )
    {
      ...
      bool result = negFlag ? XInt64.TryParse( "-" + zNum, out pNum ) : XInt64.TryParse( zNum, out pNum );
